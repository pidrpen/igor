    ...
    specs: [
      ...
      // ═════════════════════════════════════
      {
        ...
        abilities: [
          ...
          A({ id: 'jade_lotus', n: 'Удар нефритового лотоса', en: 'Jade Lotus Strike', i: '🌸',
            c: 0, cd: 3, t: 'damage', fl: 30, school: 'nature',
            d: '30т · бесплатно · КД 3', sid: 121253 }),
          A({ id: 'jab', n: 'Джаб', en: 'Jab', i: '👊',
            c: 0, t: 'damage', fl: 15, school: 'physical',
            d: '15т', sid: 100780 }),
          A({ id: 'sck', n: 'Танцующий журавль', en: 'Spinning Crane Kick', i: '🌪️',
            c: 5, t: 'aoe', fl: 10, school: 'physical',
            d: '10т область · 5 маны', sid: 101546 }),
      ...
      // ═════════════════════════════════════
      {
        ...
        abilities: [
          ...
          A({ id: 'sck', n: 'Танцующий журавль', en: 'Spinning Crane Kick', i: '🌪️',
            c: 26, t: 'aoe', fl: 14, school: 'physical',
            d: '14т область · 26 энергии', sid: 101546 }),
