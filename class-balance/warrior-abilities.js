    ...
    // ─── Protection (ребаланс: блок/парир + free Revenge) ──
    {
      ...
      abilities: [
        ...
        A({ id: 'revenge', n: 'Реванш', en: 'Revenge', i: '↩️',
          c: 15, cd: 2, t: 'aoe', fl: 17, school: 'physical', d: '17т AoE · 15 ярости · авто только при парировании', sid: 6572 }),
        ...
        A({ id: 'shield_block', n: 'Блок щитом', en: 'Shield Block', i: '🧱',
          ...
          d: '2 заряда · откат при <2 · +50% блок / +20% сила · 2 хода · без хода', sid: 2565 }),
        A({ id: 'shield_wall', n: 'Глухая оборона', en: 'Shield Wall', i: '🏰',
          cd: 8, t: 'buff', fa: 1, dr: 0.6, bt: 2, d: '', sid: 871 }),
        A({ id: 'last_stand', n: 'Ни шагу назад', en: 'Last Stand', i: '❤️',
          cd: 10, t: 'buff', fa: 1, hpPct: 0.5, bt: 3, grantBlock: 1, d: '', sid: 12975 }),
        A({ id: 'taunt', n: 'Провокация', en: 'Taunt', i: '📢',
          cd: 2, t: 'taunt', p: 0, fa: 1, d: '', sid: 355 }),
        A({ id: 'heroic_leap', n: 'Героический прыжок', en: 'Heroic Leap', i: '🦘',
          cd: 5, t: 'aoe', fl: 2, fa: 1, dr: 0.05, bt: 2, school: 'physical', d: '', sid: 6544 }),
