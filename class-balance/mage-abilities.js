      ...
      // ═══════════════════════════════════════
      {
        ...
        abilities: [
          A({ id: 'ab', n: 'Чародейская вспышка', en: 'Arcane Blast', i: '💜',
            c: 10, t: 'damage', fl: 24, school: 'arcane',
            d: '24т · 10 маны · повтор +4 маны (макс +12)', sid: 30451 }),
          A({ id: 'am', n: 'Чародейские стрелы', en: 'Arcane Missiles', i: '✨',
            c: 7, t: 'damage', fl: 22, school: 'arcane',
            d: '22т · 7 маны', sid: 5143 }),
          A({ id: 'abarr', n: 'Чародейский обстрел', en: 'Arcane Barrage', i: '💠',
            c: 6, cd: 2, t: 'damage', fl: 20, school: 'arcane',
            d: '20т + 6т за стак · 6 маны · КД 2 · сброс стаков', sid: 44425 }),
      ...
      // ═══════════════════════════════════════
      {
        ...
        abilities: [
          A({ id: 'fireball', n: 'Огненный шар', en: 'Fireball', i: '🔥',
            ...
            d: '22т · 7 маны · крит → глыба 10 маны / 90т', sid: 133 }),
          ...
          A({ id: 'scorch', n: 'Ожог', en: 'Scorch', i: '🌡️',
            ...
            applyDot: { flat: 5, turns: 4, name: 'Возгорание', icon: '🔥', id: 'combustion', school: 'fire' },
            d: '16т + Возгорание 5т×4', sid: 2948 }),
          ...
          A({ id: 'flamestrike', n: 'Огненный столб', en: 'Flamestrike', i: '🌋',
            c: 11, cd: 4, t: 'aoe', fl: 14, school: 'fire',
            d: '14т область · КД 4 · 33% крит следующего шара', sid: 2120 }),
          A({ id: 'mirror', n: 'Зеркальное изображение', en: 'Mirror Image', i: '🪞',
