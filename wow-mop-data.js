    ...
    // ═══════════════════════════════════════
    {
      ...
      specs: [
        ...
        },
        {
          ...
          abilities: [
            A({ id: 'zap_gun', n: 'Электропушка', en: 'Zap Gun', i: '⚡', g: 18, gs: 1, t: 'damage', p: 1.08, d: 'Разряд. +Пар, +1 деталь.', sid: 90021 }),
            A({ id: 'flux_bolt', n: 'Поток флюкса', en: 'Flux Bolt', i: '🌀', c: 28, gs: 1, t: 'damage', p: 1.28, d: 'Нестабильный заряд. +1 деталь.', sid: 90022 }),
            A({ id: 'death_ray', n: 'Гномский луч смерти', en: 'Gnomish Death Ray', i: '☢️', c: 45, cd: 2, t: 'damage', p: 1.7, d: 'Рискованный мощный луч.', sid: 90023 }),
            A({ id: 'rocket_chicken', n: 'Ракета-курица', en: 'Rocket Chicken', i: '🐔', c: 30, cs: 1, cd: 3, t: 'summon', p: 1, d: 'Боевая курица-ракета на 3 хода. 1 деталь.', sid: 90024 }),
            A({ id: 'world_destroyer', n: 'Личный разрушитель миров', en: 'World Destroyer', i: '🤖', c: 50, cs: 3, cd: 5, t: 'summon', p: 1, d: 'Мини-танк гномов на 3 хода. 3 детали.', sid: 90025 }),
            A({ id: 'shrink_ray', n: 'Уменьшающий луч', en: 'Shrink Ray', i: '🔬', c: 25, cd: 3, t: 'debuff', p: 0.15, d: 'Цель слабее (−ATK) на время.', sid: 90026 }),
            A({ id: 'magnetic_grip', n: 'Магнитный захват', en: 'Magnetic Grip', i: '🧲', c: 20, cd: 3, t: 'cc', p: 1, d: 'Стан 1 ход + сбив каста.', sid: 90027 }),
            A({ id: 'scrap_swarm', n: 'Рой металлолома', en: 'Scrap Swarm', i: '🐝', c: 40, cs: 2, cd: 4, t: 'summon', p: 1, d: '3 скрап-бота на 2 хода. 2 детали.', sid: 90028 }),
            A({ id: 'shock_wrench', n: 'Шоковый ключ', en: 'Shock Wrench', i: '⚡', c: 15, cd: 2, t: 'interrupt', p: 0.4, d: 'Сбивает каст. Немота 2 хода.', sid: 90009 }),
          ],
        },
      ],
