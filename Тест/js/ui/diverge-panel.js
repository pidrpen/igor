 ...
 */
  ...
  const DIVERGE_LOG = [
    ...
    },
    {
      ...
      poured: 'yes',
      pourVer: '5.4.9.25',
      text: 'В начале боя каждый живой класс вешает свой бафф на отряд и питомцев. Два одинаковых не складывают, разные складываются. Показ в окне «Пассивные бафы» слева снизу (кто даёт и что), не в рамке портрета. Тест и основа с 5.4.9.25.',
    },
    {
      id: 'hunter-pets',
