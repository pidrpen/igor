  ...
  const DIVERGE_LOG = [
    {
      ...
      poured: 'no',
      testVer: '5.4.9.41В',
      text: 'Выпад атакующего, встряска цели, тряска поля на крите, «след» снятого HP, смерть врага с пеплом (js/ui/fx.js, css/main.css). Значок угрозы — портрет и имя цели, красный вне танка; ряд карточек ужимается под ширину поля, столбик баффов по числу иконок (js/ui/combat-ui.js, css/test-room.css). Баффы отряда свёрнуты по умолчанию (js/systems/passives.js). Магазин не закрывает «Сдаться». Цифры боя не менялись.',
    },
    {
      id: 'cloud-save',
    ...
    },
    {
      ...
      poured: 'no',
      testVer: '5.4.9.27В',
      text: 'Хаб: тест анимаций, рисовка, тушь, арена спрайтов. Живой бой — инст 4 зала (двор → галерея → медитация → ша), WASD, ИИ врагов, паладин и шаман союзники. На основе комнаты и спрайтов нет.',
    },
    {
      id: 'hero-nick',
