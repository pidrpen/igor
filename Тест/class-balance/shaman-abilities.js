...
function A(o) {
  ...
  const ENGINE_NEEDS = {
    ...
    lavaBurstFlameShock: {
      present: true,
      scope: 'elemental',
      engineNote: 'Выброс лавы — гарантированный крит, если на цели Огненный шок наложившего.',
    },
    unleashElementsHits: {
      present: true,
      scope: 'enhancement',
      engineNote: '+15% на следующие 2 удара (abilityCharges), не +атака на 3 хода.',
    },
    unleashLifeBuff: {
      present: true,
      scope: 'restoration',
      engineNote: 'healAmp + nextHealCharges на Высвободить жизнь.',
    },
    healingStreamHot: {
      present: false,
      scope: 'restoration',
      ...
      // ─────────────────────────────────────
      {
        ...
        abilities: [
          A({ id: 'lv', n: 'Выброс лавы', en: 'Lava Burst', i: '🌋',
            c: 8, cd: 2, t: 'damage', fl: 32, school: 'fire',
            d: '32т · КД 2 · крит если висит Огненный шок', sid: 51505 }),
          ...
          A({ id: 'flame_shock', n: 'Огненный шок', en: 'Flame Shock', i: '🔥',
            c: 6, cd: 2, t: 'dot', fl: 8, school: 'fire',
            applyDot: { flat: 5, turns: 5, name: 'Огненный шок', id: 'flame_shock', icon: '🔥', school: 'fire' },
            d: '8т + 5т×5 · сетап крита Выброса лавы', sid: 8050 }),
          A({ id: 'earth_shock', n: 'Земной шок', en: 'Earth Shock', i: '🌍',
            c: 8, cd: 2, t: 'damage', fl: 24, school: 'nature',
            d: '24т · КД 2 (без Fulmination)', sid: 8042 }),
          ...
          A({ id: 'ele_blast', n: 'Взрыв стихий', en: 'Elemental Blast', i: '💫',
            c: 10, cd: 2, t: 'damage', fl: 38, school: 'nature',
            d: '38т · КД 2 · жирнее Выброса лавы', sid: 117014 }),
      ...
      // ─────────────────────────────────────
      {
        ...
        abilities: [
          A({ id: 'stormstrike', n: 'Удар бури', en: 'Stormstrike', i: '⛈️',
            c: 8, cd: 2, t: 'damage', fl: 32, school: 'physical',
            d: '32т · ядро ротации · КД 2', sid: 17364 }),
          A({ id: 'lava_lash', n: 'Вскипание лавы', en: 'Lava Lash', i: '🌋',
            c: 7, cd: 2, t: 'damage', fl: 30, school: 'fire',
            d: '30т · вторая рука · КД 2', sid: 60103 }),
          A({ id: 'flame_shock', n: 'Огненный шок', en: 'Flame Shock', i: '🔥',
            c: 6, cd: 2, t: 'dot', fl: 7, school: 'fire',
            applyDot: { flat: 4, turns: 5, name: 'Огненный шок', id: 'flame_shock', icon: '🔥', school: 'fire' },
          ...
          A({ id: 'unleash', n: 'Высвободить стихии', en: 'Unleash Elements', i: '✨',
            c: 5, cd: 2, t: 'buff', fa: 1, p: 0.15, abilityCharges: 2, school: 'none',
            d: '+15% на следующие 2 удара · без хода', sid: 73680 }),
          A({ id: 'fire_nova', n: 'Кольцо огня', en: 'Fire Nova', i: '💥',
            c: 9, cd: 2, t: 'aoe', fl: 20, school: 'fire',
            d: '20т область · только если на цели Огненный шок', sid: 1535 }),
      ...
      // ─────────────────────────────────────
      {
        ...
        abilities: [
          A({
            ...
            c: 4, cd: 2, t: 'heal', fl: 22,
            applyHot: { flat: 5, turns: 5, name: 'Быстрина' },
          ...
          A({
            ...
            c: 13, t: 'heal_aoe', fl: 35, chainDecay: 0.05, chainPrimary: true,
            d: '35т · сначала выбранная, дальше по %HP (−5%/скачок)', sid: 1064,
          }),
          A({
            id: 'hw', n: 'Волна исцеления', en: 'Healing Wave', i: '🌊',
            c: 8, t: 'heal', fl: 25, d: 'СТ · 25т', sid: 331,
          }),
          A({
            id: 'chw', n: 'Исцеляющий всплеск', en: 'Healing Surge', i: '💧',
            c: 13, t: 'heal', fl: 34, d: 'СТ · 34т · авария', sid: 8004,
          }),
          A({
          ...
          A({
            ...
            applyDot: { flat: 4, turns: 6, name: 'Огненный шок', id: 'flame_shock', icon: '🔥', school: 'fire' }, d: '', sid: 8050,
          }),
          A({
            id: 'spirit_link', n: 'Тотем духовной связи', en: 'Spirit Link Totem', i: '🔗',
            c: 0, cd: 5, t: 'heal_aoe', fl: 15, dr: 0.1, bt: 3,
            d: '15т область · −10% урон 3х · выравнивание каждые 2 удара', sid: 98008,
          }),
        ],
      },
    ],
