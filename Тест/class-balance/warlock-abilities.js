...
function A(o) {
    ...
    specs: [
      {
        ...
        abilities: [
          A({ id: 'agony', n: 'Агония', en: 'Agony', i: '😣',
            c: 5, cd: 1, t: 'dot', fl: 8, school: 'shadow',
            applyDot: { flat: 5, turns: 6, name: 'Агония', school: 'shadow' },
            d: '8т + DoT 5т×6', sid: 980 }),
          A({ id: 'corruption', n: 'Порча', en: 'Corruption', i: '🟢',
            c: 4, t: 'dot', fl: 8, school: 'shadow',
            applyDot: { flat: 5, turns: 5, name: 'Порча', school: 'shadow' },
            d: '8т + DoT 5т×5', sid: 172 }),
          A({ id: 'ua', n: 'Нестабильное колдовство', en: 'Unstable Affliction', i: '💜',
            c: 7, cd: 1, t: 'dot', fl: 10, school: 'shadow',
            applyDot: { flat: 6, turns: 5, name: 'Нестабильное колдовство', school: 'shadow' },
            d: '10т + DoT 6т×5', sid: 30108 }),
          A({ id: 'malefic', n: 'Хватка малефиция', en: 'Malefic Grasp', i: '🖐️',
            c: 7, t: 'damage', fl: 20, school: 'shadow',
            d: '20т · канал-заполнитель', sid: 103103 }),
          A({ id: 'haunt', n: 'Блуждающий дух', en: 'Haunt', i: '👻',
            c: 8, cs: 1, cd: 2, t: 'damage', fl: 32, school: 'shadow',
            d: '32т · 1 осколок · КД 2', sid: 48181 }),
      ...
      },
      {
        ...
        abilities: [
          ...
          A({ id: 'immolate', n: 'Жертвенный огонь', en: 'Immolate', i: '🕯️',
            ...
            applyDot: { flat: 5, turns: 5, name: 'Жертвенный огонь', school: 'fire' },
            d: '8т + DoT 5т×5', sid: 348 }),
          ...
          A({ id: 'conflag', n: 'Поджигание', en: 'Conflagrate', i: '💥',
            c: 5, gs: 1, cd: 1, t: 'damage', fl: 20, school: 'fire',
            d: '20т · +1 осколок · КД 1', sid: 17962 }),
          ...
          A({ id: 'havoc', n: 'Хаос', en: 'Havoc', i: '🎯',
            c: 5, cd: 3, t: 'debuff', fa: 1, enemyDmgMod: 0.1, bt: 3, school: 'none',
            d: '−10% урона цели · 3 хода · без хода · КД 3', sid: 80240 }),
          A({ id: 'dark_soul', n: 'Тёмная душа: Нестабильность', en: 'Dark Soul: Instability', i: '😈',
            cd: 5, t: 'buff', fa: 1, atkMod: 0.25, bt: 3, school: 'none',
            d: '+25% атаки · 3 хода · без хода', sid: 113858 }),
  ...
  const WARLOCK_BALANCE = {
    version: 'mop-5.4.8-lite-warlock-v1-test',
    class: WARLOCK_CLASS,
    engineNeeds: ENGINE_NEEDS,
