...
ENGINE_ROWS = [
    ...
    ["dot_per_caster", "Доты и дебаффы по кастеру", "applyStatus затирает любой бафф с тем же id. Два кота — одно кровотечение.",
     "id+fromUid. Урон и уязв. только наложившему. Стан/рёв/личные баффы — один на id.",
     "Все спеки, два одинаковых в пати"],
]
