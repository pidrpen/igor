/* ui/balance-panel: patch log + lobby balance UI */
  ...
  const BALANCE_HISTORY = [
    {
      version: '5.4.8.beta.7',
      date: '2026-08-15',
      title: 'β Бета · разбор Excel · рейд под дворцом',
      beta: true,
      changes: [
        {
          classId: 'system',
          className: 'Разбор баланса',
          text: 'Жёлтые задачи в баланс_полный_обзор.xlsx. Цифры кнопок в бою ещё не массово меняли — это ТЗ.',
          lines: [
            'Движок 5–24 закрыт (доты, крит Шока, пустой баф, броня %, кд 1→2, Искупление, Хаос-метка…).',
            'Правило: кто тратит ресурс, может бить жирнее копилки. Лист Кнопки считает голые т без ресурса.',
            'Роли R1–R3. Спеки S01–S09 (воин, паладин, охотник). Дальше разбойник S10.',
            'Файлы: Тест/СЕССИЯ_разбор_баланса.md · задачи_мне.txt · бэклог_ветки.md',
          ],
        },
        {
          classId: 'warrior',
          className: 'Воин',
          text: 'Оружие: Мощный удар не резать. Неистовство: Жажда кд 3 / +20 ярости; Выпад 2 заряда, +10 ярости, 23т×2. Защита: гром без хода.',
        },
        {
          classId: 'paladin',
          className: 'Паладин',
          text: 'Свет: Слово славы 80/3 энергии ок. Защита: в целом ок. Молот гнева (танк и боец) — один раз за ход. Воздаяние: без правок, ждать сравнение 1/5/10.',
        },
        {
          classId: 'hunter',
          className: 'Охотник',
          text: 'Команда «Взять!» кд 2. Быстрая стрельба у зверей — решить на листе класса. Стрельба: шквал после 1/5/10. Выживание не разбирать.',
        },
        {
          classId: 'system',
          className: 'Рейд 10',
          text: 'Читаемый HUD, смена танков кнопкой, соки кликом, метки «разойтись», проводники щитят босса. На 50% — провал под дворец, шкалы Небесного гнева, волны стражи; после зачистки босс падает в ту же комнату.',
        },
      ],
    },
    {
