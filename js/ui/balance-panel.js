  ...
  const BALANCE_HISTORY = [
    {
      version: '5.4.9.33',
      date: '2026-08-23',
      title: 'Лут рейда, паки ключа, копия монастыря, ход ждёт ролик',
      beta: false,
      changes: [
        {
          classId: 'system',
          ...
          specId: 'raid',
          specName: 'Рейд 10',
          text: 'После Лэй Шэня — 1 из 3 аксессуаров. Кнопка в бою, без хода, раз за бой. Копия в общую сумку. Обычный: щит 20% max HP / −40% входящего 2 хода / +20% атаки 2 хода. Героический: 30% / −50% / +30%. Таймер обычный 15:00, героический 10:00.',
        },
        {
          classId: 'system',
          className: 'Система',
          specId: 'key',
          specName: 'Ключ 5',
          text: 'Паки разные на вратах / коридоре / развилке после мида. Нефритовый Монастырь: после Смятения в ряду союзников копия героя. Хил кормит врага, удар снимает.',
        },
        {
          classId: 'system',
          className: 'Система',
          specId: 'ui',
          specName: 'Бой',
          text: 'Ход ждёт ролик около 42% длины, потолок 280 мс.',
        },
      ],
    },
    {
      ...
      changes: [
        {
          ...
          specId: 'ui',
          specName: 'Пассивки',
          text: 'Карман «Пассивные способности» слева снизу только пассивки того, кем играете. Классовые баффы отряда — отдельный карман «Баффы отряда» справа снизу: кто даёт и что. На ходе авто оба не гаснут.',
        },
      ],
    },
    {
      version: '5.4.9.27',
      date: '2026-08-21',
      title: 'Ник в бою. Телеграф и имя комнаты',
      beta: false,
      changes: [
        {
          classId: 'system',
      ...
      changes: [
        {
          ...
          specId: 'meter',
          specName: 'Recount',
          text: 'Поглощение щита пишется в исцеление тому, кто наложил. В деталях скилла пометка «(щит)», если в имени ещё нет слова щит.',
        },
        {
          classId: 'warrior',
          className: 'Воин',
      ...
      changes: [
        {
          ...
          specId: 'ai',
          specName: 'ИИ',
          text: 'Ключ 5 и рейд 10 крутят одну ротацию partyAiAct. Запасной набор кнопок в raidAllyAi снят.',
        },
        {
          classId: 'system',
          className: 'Система',
          specId: 'ui',
          specName: 'Управление',
          text: 'Клик по герою в рейде берёт управление и сразу отдаёт текущий чужой ход авто. Если выбранного нет — таверна, затем последний выбор, затем боец, не первый танк.',
        },
        {
          classId: 'system',
          className: 'Система',
